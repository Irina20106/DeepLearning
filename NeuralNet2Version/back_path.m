function [net,dW1,dW2] = back_path(net, y_layer1, dy_layer1, y_layer2, dy_layer2, data_in, data_out,speed,dW10,dW20,alf,simple,L2)
...
%     sigma2 = dy_layer2.*Err;
      sigma2 = data_out - y_layer2;
%     y_layer1 = sum(y_layer1,1)/size(y_layer1,1);
    dW2 = (y_layer1'*sigma2);
    dW2 = speed*(dW2 + L2.*net.weight2)+alf*dW20;
...
%     data = sum(data_in,1)/size(data_in,1);
    data = data_in;
    dW1 = data'*sigma1;
    dW1 = speed*(dW1+L2.*net.weight1)+alf*dW10;
